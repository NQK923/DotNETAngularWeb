...
public static class InfoAccountApi
{
    ...
    {
        endpointRouteBuilder.MapPost("/infoAccount/CreateInfoAccount",
            async (CreateInfoAccountRequest createInfoAccount, InfoAccountDbContext dBContext) =>
            {
                var newInfoAccount = new ModelInfoAccount
                {
