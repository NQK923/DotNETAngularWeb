...
namespace UserService
{
    public static class AccountAPI
    {
        ...
        {
            endpointRouteBuilder.MapPut("/account/changePasswordAccountByID", async (ChangePasswordRequest changePasswordRequest, UserServiceDBContext dBContext) =>
            {
        ...
        {
            endpointRouteBuilder.MapPost("/account/checkOldPasswordAccountByID", async (CheckOldPasswordRequest checkOldPasswordRequest, UserServiceDBContext dBContext) =>
            {
        ...
        public static void MapGetListAccount(this IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            {
                List<Account> list = await dBContext.accounts.ToListAsync();
        ...
        {
            endpointRouteBuilder.MapPost("/account/checkExistExternalAccount", async (string username, HttpContext httpContext, UserServiceDBContext dBContext) =>
            {
                ...
                switch (account.status)
                {
                    case false when (account.banDate < DateTime.Now) || account.banDate == null:
                        account.status = true; await dBContext.SaveChangesAsync();
                        break;
        ...
        {
            endpointRouteBuilder.MapPost("/account/register", async (LoginRegisterRequest loginRegisterRequest, UserServiceDBContext dBContext) =>
            {
        ...
        {
            endpointRouteBuilder.MapPost("/account/login", async (LoginRegisterRequest loginRegisterRequest, HttpContext httpContext, UserServiceDBContext dBContext) =>
            {
        ...
        {
            endpointRouteBuilder.MapPost("/account/externalAccountRegister", async (string username, UserServiceDBContext dBContext) =>
            {
                var newAccount = new Account
                {
                    username = username,
        ...
        {
            endpointRouteBuilder.MapPut("/acccount/changeBanDateAccountByID", async (ChangeBanDateRequest changeBanDateRequest, UserServiceDBContext dBContext) =>
            {
